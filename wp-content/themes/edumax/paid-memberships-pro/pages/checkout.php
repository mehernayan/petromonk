...
<form id="pmpro_form" class="pmpro_form" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
	...
	<div class="row">
		...
		<div id="pmpro_user_fields" class="pmpro_checkout">
			<h3 class="form-heading-title">
				<span class="pmpro_checkout-h3-name"><?php _e('Account Information', 'edumax' );?></span>
			</h3>
			<p class="already-have-account"><span class="pmpro_checkout-h3-msg"><?php _e('Already have an account?', 'edumax' );?> <a href="<?php echo wp_login_url(pmpro_url("checkout", "?level=" . $pmpro_level->id)); ?>"><?php _e('Log in here', 'edumax' );?></a></span></p>
			<div class="pmpro_checkout-fields">
				<div class="pmpro_checkout-field pmpro_checkout-field-username">
					<label for="username"><?php _e('Username', 'edumax' );?></label>
			...
			<div class="pmpro_checkout-field pmpro_checkout-field-bemail">
					<label for="bemail"><?php _e('E-mail Address', 'edumax' );?></label>
				...
				<?php
					...
					if($pmpro_checkout_confirm_email) { ?>
						<div class="pmpro_checkout-field pmpro_checkout-field-bconfirmemail">
							<label for="bconfirmemail"><?php _e('Retype E-mail Address', 'edumax' );?></label>
				...
				<div class="pmpro_checkout-field pmpro_checkout-field-password">
					<label for="password"><?php _e('Password', 'edumax' );?></label>
				...
				<?php
					...
					if($pmpro_checkout_confirm_password) { ?>
						<div class="pmpro_checkout-field pmpro_checkout-field-password2">
							<label for="password2"><?php _e('Retype Passwrod', 'edumax' );?></label>
				...
				<div class="pmpro_hidden">
					<label for="fullname"><?php _e('Full Name', 'edumax' );?></label>
					<input id="fullname" name="fullname" type="text" class="input <?php echo pmpro_getClassForField("fullname");?>" size="30" value="" /> <strong><?php _e('LEAVE THIS BLANK', 'edumax' );?></strong>
		...
		<?php } elseif($current_user->ID && !$pmpro_review) { ?>
			<div id="pmpro_account_loggedin" class="pmpro_message pmpro_alert">
				<?php printf(__('You are logged in as <strong>%s</strong>. If you would like to use a different account for this membership, <a href="%s">log out now</a>.', 'edumax' ), $current_user->user_login, wp_logout_url($_SERVER['REQUEST_URI'])); ?>
		...
		<div id="pmpro_payment_method" class="pmpro_checkout" <?php if(!$pmpro_requirebilling) { ?>style="display: none;"<?php } ?>>
			<hr />
			<h3>
				<span class="pmpro_checkout-h3-name"><?php _e('Choose your Payment Method', 'edumax' ); ?></span>
			</h3>
			<div class="pmpro_checkout-fields">
				<span class="gateway_paypal">
					<input type="radio" name="gateway" value="paypal" <?php if(!$gateway || $gateway == "paypal") { ?>checked="checked"<?php } ?> />
					<a href="javascript:void(0);" class="pmpro_radio"><?php _e('Check Out with a Credit Card Here', 'edumax' );?></a>
				</span>
				<span class="gateway_paypalexpress">
					...
					<a href="javascript:void(0);" class="pmpro_radio"><?php _e('Check Out with PayPal', 'edumax' );?></a>
				</span>
			</div> <!-- end pmpro_checkout-fields -->
		...
		<div id="pmpro_billing_address_fields" class="pmpro_checkout" <?php if(!$pmpro_requirebilling || apply_filters("pmpro_hide_billing_address_fields", false) ){ ?>style="display: none;"<?php } ?>>
			...
			<h3 class="form-heading-title mt-5 mb-4">
				<span class="pmpro_checkout-h3-name"><?php _e('Billing Address', 'edumax' );?></span>
			</h3>
			<div class="pmpro_checkout-fields">
				<div class="pmpro_checkout-field pmpro_checkout-field-bfirstname">
					<label for="bfirstname"><?php _e('First Name', 'edumax' );?></label>
				...
				<div class="pmpro_checkout-field pmpro_checkout-field-blastname">
					<label for="blastname"><?php _e('Last Name', 'edumax' );?></label>
				...
				<div class="pmpro_checkout-field pmpro_checkout-field-baddress1">
					<label for="baddress1"><?php _e('Address 1', 'edumax' );?></label>
				...
				<div class="pmpro_checkout-field pmpro_checkout-field-baddress2">
					<label for="baddress2"><?php _e('Address 2', 'edumax' );?></label>
				...
				<?php
					...
					if($longform_address) { ?>
						<div class="pmpro_checkout-field pmpro_checkout-field-bcity">
							<label for="bcity"><?php _e('City', 'edumax' );?></label>
						...
						<div class="pmpro_checkout-field pmpro_checkout-field-bstate">
							<label for="bstate"><?php _e('State', 'edumax' );?></label>
						...
						<div class="pmpro_checkout-field pmpro_checkout-field-bzipcode">
							<label for="bzipcode"><?php _e('Postal Code', 'edumax' );?></label>
					...
					<?php } else { ?>
						<div class="pmpro_checkout-field pmpro_checkout-field-bcity_state_zip">
							<label for="bcity_state_zip"><?php _e('City, State Zip', 'edumax' );?></label>
				...
				<?php
					...
					if($show_country) { ?>
						<div class="pmpro_checkout-field pmpro_checkout-field-bcountry">
							<label for="bcountry"><?php _e('Country', 'edumax' );?></label>
				...
				<div class="pmpro_checkout-field pmpro_checkout-field-bphone">
					<label for="bphone"><?php _e('Phone', 'edumax' );?></label>
				...
				<?php
					...
					if($pmpro_checkout_confirm_email) { ?>
						<div class="pmpro_checkout-field pmpro_checkout-field-bconfirmemail">
							<label for="bconfirmemail"><?php _e('Confirm E-mail', 'edumax' );?></label>
							<input id="bconfirmemail" name="bconfirmemail" type="<?php echo ($pmpro_email_field_type ? 'email' : 'text'); ?>" class="input <?php echo pmpro_getClassForField("bconfirmemail");?>" size="30" value="<?php echo esc_attr($bconfirmemail); ?>" />
						</div> <!-- end pmpro_checkout-field-bconfirmemail -->
					<?php } else { ?>
						<input type="hidden" name="bconfirmemail_copy" value="1" />
		...
		<?php
			...
			<div id="pmpro_payment_information_fields" class="pmpro_checkout" <?php if(!$pmpro_requirebilling || apply_filters("pmpro_hide_payment_information_fields", false) ) { ?>style="display: none;"<?php } ?>>
				...
				<h3 class="form-heading-title mt-5">
					<span class="pmpro_checkout-h3-name"><?php _e('Payment Information', 'edumax' );?></span>
				</h3>
				<p>
					<span class="pmpro_checkout-h3-msg"><?php printf(__('We Accept %s', 'edumax' ), $pmpro_accepted_credit_cards_string);?></span>
				</p>
				...
				<div class="pmpro_checkout-fields">
					<?php
						...
						if($pmpro_include_cardtype_field) { ?>
							<div class="pmpro_checkout-field pmpro_payment-card-type">
								<label for="CardType"><?php _e('Card Type', 'edumax' );?></label>
					...
					<div class="pmpro_checkout-field pmpro_payment-account-number">
						<label for="AccountNumber"><?php _e('Card Number', 'edumax' );?></label>
					...
					<div class="pmpro_checkout-field pmpro_payment-expiration">
						...
						<div class="row">
							...
							<label for="ExpirationMonth"><?php _e('Expiration Date', 'edumax' );?></label>
					...
					<?php
						...
						<div class="pmpro_checkout-field pmpro_payment-cvv">
							<label for="CVV"><?php _e('CVC ', 'edumax' );?>
							<small class="cvc-info">(<a href="javascript:void(0);" onclick="javascript:window.open('<?php echo pmpro_https_filter(PMPRO_URL); ?>/pages/popup-cvv.html','cvv','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=600, height=475');"><?php _e("what's this?", 'edumax' );?></a>)</small>
							</label>
	...
	<?php echo wpautop(do_shortcode($tospage->post_content));?>
					...
					<input type="checkbox" name="tos" value="1" id="tos" /> <label class="pmpro_label-inline pmpro_clickable" for="tos"><?php printf(__('I agree to the %s', 'edumax' ), $tospage->post_title);?></label>
				</div> <!-- end pmpro_checkout-fields -->
		...
		<div class="pmpro_submit">
			...
			<?php if($pmpro_review) { ?>
				...
				<span id="pmpro_submit_span">
					...
					<input type="submit" id="pmpro_btn-submit" class="pmpro_btn pmpro_btn-submit-checkout" value="<?php _e('Complete Payment', 'edumax' );?> &raquo;" />
				</span>
			...
			<?php } else { ?>
				...
				<?php
					...
					<span id="pmpro_submit_span">
						...
						<input type="submit"  id="pmpro_btn-submit" class="pmpro_btn pmpro_btn-submit-checkout" value="<?php if($pmpro_requirebilling) { _e('Get Started', 'edumax' ); } else { _e('Submit and Confirm', 'edumax' );}?> &raquo;" />
					</span>
					<?php
					}
				?>
			...
			<span id="pmpro_processing_message" style="visibility: hidden;">
				<?php
					$processing_message = apply_filters("pmpro_processing_message", __("Processing...", 'edumax' ));
		...
		<div class="col-lg-6">
			<?php if($pmpro_review) { ?>
			<p><?php _e('Almost done. Review the membership information and pricing below then <strong>click the "Complete Payment" button</strong> to finish your order.', 'edumax' );?></p>
		<?php } ?>
		...
		<?php
			...
			<div id="pmpro_pricing_fields" class="pmpro_checkout">
				<h3 class="membership-block-title">
					...
					<?php printf(__('<strong>%s</strong>', 'edumax' ), $pmpro_level->name);?>
					</span>
			
					<?php if(count($pmpro_levels) > 1) { ?><span class="pmpro_checkout-h3-msg float-right"><a href="<?php echo pmpro_url("levels"); ?>"><?php _e('change', 'edumax' );?></a></span><?php } ?>
				</h3>
				...
				<div class="pmpro_checkout-fields">
					<p class="checkout-details-text">
						<?php printf(__('You have selected the <strong>%s</strong> membership level.Can you guarantee how much money your store is going to make this month? If you offered subscription-based products.', 'edumax' ), $pmpro_level->name);?>
					</p>
					...
					<div id="pmpro_level_cost">
						<?php if($discount_code && pmpro_checkDiscountCode($discount_code)) { ?>
							<?php printf(__('<p class="pmpro_level_discount_applied">The <strong>%s</strong> code has been applied to your order.</p>', 'edumax' ), $discount_code);?>
						<?php } ?>
		...
		?>
			...
			<div class="discount-wrap">
				<?php if($pmpro_show_discount_code) { ?>
					<?php if($discount_code && !$pmpro_review) { ?>
						<p id="other_discount_code_p" class="pmpro_small"><a id="other_discount_code_a" href="#discount_code"><?php _e('Click here to change your discount code.', 'edumax' );?></a></p>
					<?php } elseif(!$pmpro_review) { ?>
						<p id="other_discount_code_p" class="pmpro_small"><?php _e('Do you have a discount code?', 'edumax' );?></p>
					<?php } elseif($pmpro_review && $discount_code) { ?>
						<p><strong><?php _e('Discount Code', 'edumax' );?>:</strong> <?php echo $discount_code?></p>
					<?php } ?>
				<?php } ?>
				...
				<?php if($pmpro_show_discount_code) { ?>
					<div class="pmpro_checkout-field pmpro_payment-discount-code">
						...
						<div class="row discount-input-block">
							...
							<div class="col-sm-4">
								<input type="button" id="discount_code_button" name="discount_code_button" value="<?php _e('Apply Code', 'edumax' );?>" />
							</div>
						</div>
				...
				<div id="other_discount_code_tr" style="display: none;">
					<label for="other_discount_code"><?php _e('Discount Code', 'edumax' );?></label>
					...
					<input type="button" name="other_discount_code_button" id="other_discount_code_button" value="<?php _e('Apply', 'edumax' );?>" />
				</div>
				<?php } ?>
			</div>
